...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-azure-functions-core-tools";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need `func` on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.AzureFunctionsCoreTools.V4.Tests" / "Tamp.AzureFunctionsCoreTools.V4.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.AzureFunctionsCoreTools.V4" / "Tamp.AzureFunctionsCoreTools.V4.csproj");
